...
def Waiting(key,name,store1,store2,store3,flash,All_Trainer_Info,Move_ID):
  global Add_Power,Add_Spirit,Add_Endurance,Confuse 
  Add_Power=False
  Add_Spirit=False
  Add_Endurance=False
  Confuse=False
...
def Single_Player():
  Menu_Clear()
  global char_health,comp_health,Comp_health_label,comp_power,comp_spirit,comp_Endur,health_label,User_health,Comp_health,Comp_choice,Round,Round_naming,Option1,Option2,Option3,Option4,Option5,Add_Power,Add_Spirit,Add_Endurance,Confuse
